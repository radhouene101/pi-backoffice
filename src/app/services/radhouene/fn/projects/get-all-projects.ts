...
export function getAllProjects(http: HttpClient, rootUrl: string, params?: GetAllProjects$Params, context?: HttpContext): Observable<StrictHttpResponse<Array<ProjectsDto>>> {
